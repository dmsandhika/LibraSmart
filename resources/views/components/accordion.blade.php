<div id="accordionFlushExample">
  <div class="border border-e-0 border-s-0 border-t-0 border-neutral-200 bg-[#0d9488] rounded-xl">
    <h2 class="mb-0" id="{{ $id }}">
      <button
        class="rounded-t-xl group relative flex w-full items-center border-0 bg-[#0d9488] px-5 py-4 text-left text-base text-white transition [overflow-anchor:none] hover:z-[2] focus:z-[3] focus:outline-none [&:not([data-twe-collapse-collapsed])]:bg-[#237f77] [&:not([data-twe-collapse-collapsed])]:font-extrabold [&:not([data-twe-collapse-collapsed])]:shadow-border-b"
        type="button"
